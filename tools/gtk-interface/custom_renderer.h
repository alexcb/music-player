...
#define GTK_CELL_RENDERER_BORDER( obj )                                                            \
	( G_TYPE_CHECK_INSTANCE_CAST( ( obj ), GTK_TYPE_CELL_RENDERER_BORDER, GtkCellRendererBorder ) )

#define GTK_CELL_RENDERER_BORDER_CONST( obj )                                                      \
	( G_TYPE_CHECK_INSTANCE_CAST(                                                                  \
		( obj ), GTK_TYPE_CELL_RENDERER_BORDER, GtkCellRendererBorder const ) )

#define GTK_CELL_RENDERER_BORDER_CLASS( klass )                                                    \
	( G_TYPE_CHECK_CLASS_CAST(                                                                     \
		( klass ), GTK_TYPE_CELL_RENDERER_BORDER, GtkCellRendererBorderClass ) )

#define GTK_IS_CELL_RENDERER_BORDER( obj )                                                         \
	( G_TYPE_CHECK_INSTANCE_TYPE( ( obj ), GTK_TYPE_CELL_RENDERER_BORDER ) )

#define GTK_IS_CELL_RENDERER_BORDER_CLASS( klass )                                                 \
	( G_TYPE_CHECK_CLASS_TYPE( ( klass ), GTK_TYPE_CELL_RENDERER_BORDER ) )

#define GTK_CELL_RENDERER_BORDER_GET_CLASS( obj )                                                  \
	( G_TYPE_INSTANCE_GET_CLASS(                                                                   \
		( obj ), GTK_TYPE_CELL_RENDERER_BORDER, GtkCellRendererBorderClass ) )
...
void gtk_cell_renderer_border_set_show_top_border( GtkCellRendererBorder* cell,
												   gboolean show_top_border );
gboolean gtk_cell_renderer_border_get_show_bottom_border( GtkCellRendererBorder* cell );
void gtk_cell_renderer_border_set_show_bottom_border( GtkCellRendererBorder* cell,
													  gboolean show_bottom_border );
